System.register(['angular2/core', 'angular2/router', './crisis-list.component', './crisis-detail.component', '../services/crisis.service'], function(exports_1) {
        ...
        execute: function() {
            CrisisCenterComponent = (function () {
                ...
                CrisisCenterComponent = __decorate([
                    core_1.Component({
                        templateUrl: 'app/templates/crisis-center.template.html',
